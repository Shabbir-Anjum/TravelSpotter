...
from Synapse_Copilot.model.planner import Planner
from Synapse_Copilot.model.api_selector import APISelector
from Synapse_Copilot.model.caller import Caller
from Synapse_Copilot.utils.oas_utils import ReducedOpenAPISpec
...
class ApiLLM(Chain):
    ...
    def __init__(
        ...
        if scenario not in [
            ...
            "discord", "sheets", "trello", "jira", "salesforce", "travelspotter"
        ]:
