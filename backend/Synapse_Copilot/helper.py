...
from Synapse_Copilot.utils.utils import ColorPrint
from Synapse_Copilot.utils.oas_utils import reduce_openapi_spec
from Synapse_Copilot.model import ApiLLM

from Synapse_Copilot.model.api_selector import icl_examples as api_selector_icl
from Synapse_Copilot.model.planner import icl_examples as planner_icl
...
def populate_api_selector_icl_examples(scenario: str = None):
    with open(f"Synapse_Copilot/icl_examples/api_selector/{scenario}.txt", 'r') as f:
        examples = f.read()
...
def populate_planner_icl_examples(scenario: str = None):
    with open(f"Synapse_Copilot/icl_examples/planner/{scenario}.txt", 'r') as f:
        examples = f.read()
